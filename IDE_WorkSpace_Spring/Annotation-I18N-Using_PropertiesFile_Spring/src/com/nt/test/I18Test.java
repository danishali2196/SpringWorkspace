...
public class I18Test {
	...
	public static void main(String[] args) {
		...
		ResourceBundle bundle=ResourceBundle.getBundle("com/nt/commons/App",l);
		btn5=new JButton(bundle.getString("label1"));
		btn6=new JButton(bundle.getString("label2"));
		btn7=new JButton(bundle.getString("label3"));
		btn8=new JButton(bundle.getString("label4"));
