...
<head>
    ...
    <script type="text/javascript" src="clientSideValidation.js"></script>
    <style >
        body{
...
<h1>CUSTOMER REGISTRATION</h1>
    ...
    <form:form  method="post" commandName="custcmd"  >
        <table>
        <form:hidden path="vflag" onclick="yes"/>
            <tr>
                <td>Customer Name::</td>
                <td>
                ...
                <td>
                <span><form:errors path="cname"/></span>
            ...
            <tr>
                ...
                <td>
                <span><form:errors path="caddrs"/></span>
            ...
            <tr>
                ...
                <td>
                <span><form:errors path="mobileNo"/></span>
            ...
            <tr>
                ...
                <td>
                <span><form:errors path="billAmt"/></span>
                	<form:errors path="billAmt"/>
                </td>
            </tr>
            <tr>
